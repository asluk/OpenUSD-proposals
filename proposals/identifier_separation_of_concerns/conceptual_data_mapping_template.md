...
|---|---|---|
|[ConceptA](#concepta)| | A brief description of the concept or comment on the mapping. More details in the [drilldown](#concepta).|
| |[UsdConceptB](#usdconceptb)|Feature is not supported in format X and should be documented as a limitation for Two-Way mapping.|
